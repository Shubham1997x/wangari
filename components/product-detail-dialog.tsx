    ...
    <div className="relative">
      ...
      <div className="grid grid-cols-2 divide-x divide-hairline border-t border-hairline">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 bg-surface px-3 py-3.5 text-sm font-semibold text-ink transition-colors duration-300 hover:bg-tint active:bg-hairline"
        >
          Send Inquiry
          <svg viewBox="0 0 16 16" fill="none" className="h-4 w-4 shrink-0" aria-hidden="true">
